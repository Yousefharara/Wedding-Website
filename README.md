...
موقع دعوة زفاف تفاعلي بواجهة عربية RTL مبني بـ **Atomic Design Pattern** مع سلسلة
اشترك من الانيميشن.

## المحتوى

1. **افتتاحية متسلسلة** (`IntroSequence`)
   - بطاقة زفاف بملء الشاشة تُفتح كبطاقة بريد (طيّ 3D) بثيم زهرية وذهبية.
   - بعدها باب كامل يفتح من الجانبين ليكشف صالة الزفاف مع Zoom-in تصاعدي ثم يتلاشى.
